...
//MAP-> Muta el arreglo (Cambia el arreglo)
    ...
    //valorIteracion 1 = valorEmpieza + 1 = 0 + 1 = 1 -> Iteracion 1
    //valorIteracion 2 = valorIteracion1 + 2 = 1 + 2 = 3 -> Iteracion 5
    //valorIteracion 3 = valorIteracion2 + 3 = 3 + 3 = 6 -> Iteracion 5
    //valorIteracion 4 = valorIteracion3 + 4 = 6 + 4 = 10 -> Iteracion 5
    //valorIteracion 5 = valorIteracion4 + 5 = 10 + 5 = 15 -> Iteracion 5

    val respuestaReduce: Int = arregloDinamico
        .reduce{
            acumulado: Int, valorAcutal: Int ->
            return@reduce (acumulado + valorAcutal) // -> Logica negocio
        }
